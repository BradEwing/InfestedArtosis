        ...
        for (Plan plan : allActivePlans) {
            ...
            if (plan.getPlannedUnit() == UnitType.Zerg_Extractor) {
                ...
                if (fixed != null) {
                    ...
                    plan.setCancelSite(PlanCancelSite.PLAN_MANAGER_INVALID_BUILD_POSITION);
    ...
    private void releaseImpossiblePlans() {
        ...
        for (ManagedUnit larva: larva) {
            ...
            if (currentPlan != null && impossiblePlans.contains(currentPlan)) {
                gameState.cancelPlan(larva.getUnit(), currentPlan, PlanCancelSite.PLAN_MANAGER_RELEASE_IMPOSSIBLE);
            }
        }
        ...
        for (ManagedUnit drone: scheduledDrones) {
            ...
            if (currentPlan != null && impossiblePlans.contains(currentPlan)) {
                gameState.cancelPlan(drone.getUnit(), currentPlan, PlanCancelSite.PLAN_MANAGER_RELEASE_IMPOSSIBLE);
            }
        }
    }
