...
public class GameMap {
    ...
    /**
     * Finds the best perch tile for an overlord watching the given target position, preferring a perch
     * that sees the target and, among perches that tie on that, the one nearest the overlord.
     *
