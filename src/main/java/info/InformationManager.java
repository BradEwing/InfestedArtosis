        ...
        while (it.hasNext()) {
            ...
            if (plan.getType() == PlanType.UPGRADE) {
                ...
                if (self.getUpgradeLevel(upgradeType) > plan.getPlannedUpgradeLevel()) {
                    ...
                    it.remove();
                    gameState.cancelPlan(null, plan, PlanCancelSource.INFORMATION_UPGRADE_STOPPED);
                }
                ...
                if (self.hasResearched(techType)) {
                    ...
                    it.remove();
                    gameState.cancelPlan(null, plan, PlanCancelSource.INFORMATION_RESEARCH_STOPPED);
                }
            }
        }
    }
